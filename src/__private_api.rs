    ...
    L: VLog,
{
    ...
    vlog(
        ...
        args,
        Visual::Line {
            x0: pos1.next().unwrap_or(0.0),
            y0: pos1.next().unwrap_or(0.0),
            z0: pos1.next().unwrap_or(0.0),
            x1: pos2.next().unwrap_or(0.0),
            y1: pos2.next().unwrap_or(0.0),
            z1: pos2.next().unwrap_or(0.0),
            style,
        },
        thickness,
        color,
